...
public class JoinActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        edtUserId = (EditText) findViewById(R.id.join_userId);
        edtPassword = (EditText) findViewById(R.id.join_password);
        edtPasswordCheck = (EditText) findViewById(R.id.join_passwordCheck);
        edtName = (EditText) findViewById(R.id.join_name);
        edtEmail = (EditText) findViewById(R.id.join_email);
        edtPhoneNumber = (EditText) findViewById(R.id.join_password);
        edtNickname = (EditText) findViewById(R.id.join_nickname);
        btnRegister = (Button) findViewById(R.id.join_register);
        btnBack = (Button) findViewById(R.id.back);
        btnValid = (Button) findViewById(R.id.Id_valid);
        btnValid2 = (Button) findViewById(R.id.Nickname_valid);
...
//
    ...
    private void startJoin(JoinRequest data) {
        service.userJoin(data).enqueue(new Callback<MemberResponse>() {
            @Override
